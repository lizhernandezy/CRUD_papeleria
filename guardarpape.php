...
require 'conexion.php';
	...
	$sql = "INSERT INTO papeleria (id_papeleria, pape_nombre, pape_permiso, pape_direccion, pape_telefono, id_area, id_empleado) VALUES ('$id_papeleria', '$pape_nombre', '$pape_permiso', '$pape_direccion', '$pape_telefono', '$id_area', '$id_empleado')";
